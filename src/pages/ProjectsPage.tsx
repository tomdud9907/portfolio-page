    ...
    <section className="mx-auto mt-16 w-full max-w-6xl">
      ...
      <div className="mt-8 grid grid-cols-1 gap-5 lg:grid-cols-3">
        {projects.map((project) => (
          ...
          >
            <div className="flex h-44 items-center justify-center border-b border-[color:var(--border)] bg-black/20 text-sm uppercase tracking-[0.12em] text-[color:var(--text-muted)]">
